        ...
        <div class="container-95pct columns-03-333333-02 padding-050px">
            <div class="alignleft">
                <div class="contact-footer">
                    ...
                    <a class="fonthover-02" href="https://maps.app.goo.gl/H33giQ8yDDVQSPpx6" target="_blank" style="margin-bottom: 15px;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="#fff" width="18px" height="18px"><!--! Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2024 Fonticons, Inc. -->
                    ...
                    <a class="fonthover-02" href="tel:5144442822" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#fff" width="18px" height="18px"><!--! Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2024 Fonticons, Inc. -->
                ...
                <div class="reseaux-footer">
                    <p class="fonthover-04 bold" style="font-size: 24px;">Follow Us</p>
            ...
            <div class="alignleft">
                <div>
                    ...
                    <a href="/en/services/concrete-balcony/" class="fonthover-04 lineheight-125" style="font-size: 17px;">Concrete balconies</a><br>
                    <a href="/en/services/concrete-step/" class="fonthover-04 lineheight-125" style="font-size: 17px;">Concrete steps</a><br>
                    <a href="/en/services/formwork/" class="fonthover-04 lineheight-125" style="font-size: 17px;">Concrete formworks</a><br>
                    <a href="/en/services/house-foundation/" class="fonthover-04 lineheight-125" style="font-size: 17px;">Houses foundations</a><br>
                    ...
                    <a href="/en/services/concrete-basement/" class="fonthover-04 lineheight-125" style="font-size: 17px;">Concrete basement entrances</a><br>
            ...
            <div class="alignleft">
                ...
                <div>
                    ...
                    <p class="fonthover-04 lineheight-125" style="display:flex;">Coffrages Phoenix acceptes Bitcoin as payment for its products and services. <img src="/assets/img/bitcoin.webp" alt="Bitcoin coffrages phenoix" width="65px"></p>
                </div>
            </div>
        </div>
    </div>

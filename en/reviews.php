<style>
    @media only screen and (min-width:768px){.reviews-boxes{display:grid;grid-template-columns:33.333% 33.333% 33.333%}}
    .reviews {
    margin: 15px auto;
    display: grid;
}
...
<div class="reviews">
    ...
    overflow-y: hidden;;height: 370px;box-shadow:0 4px 5px 0 rgba(12,76,142,.38)">
      ...
      <div style="text-align: center;margin-bottom: 35px;margin-top: 25px;">
        <a href="https://g.page/r/Cd4SzOcposmSEBM/review" class="blue-button">Read more Google reviews</a>
      </div>
<script>
